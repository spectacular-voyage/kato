...
- Web session actions
  ...
  - accept an optional filename/path override through the same destination
    policy used by in-chat commands.
- Filename rendering
...
- [ ] Wire persona extraction into live/session-state in-chat record/capture
      flows.
- [ ] Add web New Capture/New Recording pre-edit fields for
      persona/participant and optional destination filename/path.
