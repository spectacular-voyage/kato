...
const COMMAND_USAGE_BODY: Record<DaemonCliCommandName, string> = {
  ...
  "workspace-register": [
    "Usage: kato workspace register [<dir>] [--alias <alias>] [--name <display-name>|name=<display-name>] [--no-restart]",
    "",
    ...
    "If --name or name=<display-name> is provided, saves an operator-facing workspace label.",
