...
In `@dev-docs/notes/completed.2026.2026-03-11-binary-distributions.md`:
...
dev-docs/notes/completed.2026.2026-03-11-binary-distributions.md entry so the
...
In `@dev-docs/notes/release-notes.v0.2.7.md`:
- Around line 1-7: The release-notes file dev-docs/notes/release-notes.v0.2.7.md
...
In `@dev-docs/notes/template.task.md`:
...
- [c] `dev-docs/notes/completed.2026.2026-03-11-binary-distributions.md`
...
- [x] `dev-docs/notes/dev.feature-ideas.md` fix the `overides` / `overrids`
      typo(s) to `overrides`.
- [c] `dev-docs/notes/dev.todo.md` reword the duplicate-`workspaceId` risk line
      into a clearer sentence that still points readers to
      `workspace_register.ts`.
- [x] `dev-docs/notes/release-notes.v0.2.7.md` populate the `v0.2.7` release
      notes. This is already done in the current tree.
- [x] `dev-docs/notes/template.task.md` add example markdown task checkboxes
